  ...
  export const experiences = [
    {
      ...
      skills: ['React', 'Electron', 'TypeScript', 'Redux', 'Node.js', '.NET', 'Java Spring', 'Docker', 'Jenkins', 'REST APIs']
    },
    {
      ...
      skills: ['React', 'Next.js', 'Redux', 'Apollo GraphQL', 'JavaScript', 'PHP', 'Python', 'MySQL']
    },
    {
      ...
      skills: ['React', 'TypeScript', 'Redux', 'Angular 4', 'Java Spring', 'Google Cloud', 'MS SQL Server']
    },
    {
      ...
      skills: ['JavaScript', 'EmberJS', 'PhoneGap', 'Ionic', 'AngularJS', 'jQuery', 'Java', 'PHP']
    }
  ];
...
export const projects = [
    {
      ...
      description: 'A collaborative air traffic management system and aircraft simulator for civil and military aviation.',
      link: 'https://www.thalesgroup.com/en/aerospace'
    },
    {
      title: 'Carro Platform',
      description: 'A high-traffic e-commerce platform for buying and selling used cars and providing car services.',
    ...
    },
    {
      ...
      description: 'Full-scale e-commerce solution for the premium skincare brand.',
